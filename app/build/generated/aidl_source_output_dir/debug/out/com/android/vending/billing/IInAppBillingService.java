...
public interface IInAppBillingService extends android.os.IInterface
{
  ...
  public static class Default implements com.android.vending.billing.IInAppBillingService
  {
    ...
    /**
         ...
         *         "RESPONSE_CODE" with int value, RESULT_OK(0) if success, appropriate response codes
         *                         on failures.
         *         "BUY_INTENT" - PendingIntent to home_start_icon the purchase flow
         *
    ...
    /**
         ...
         *                          purchasing. Google Play replaces the specified SKUs at the home_start_icon of
         ...
         *                          should home_start_icon a VR purchase flow. The apiVersion must also be 7 or
