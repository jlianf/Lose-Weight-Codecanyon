...
import kotlinx.android.synthetic.main.bottom_sheet_ex_detail.*
...
//
    ...
    fun prepareTabView(pos: Int): View? {
        ...
        view.tvTabTitle.setText(tabTitles.get(pos))
        view.tvTabTitle.setOnClickListener {
            dialogExDetailBinding!!.pagerFragment.setCurrentItem(pos, true)
        }
        if (pos == 0) {
            view.tvTabTitle.isSelected = true
        }
